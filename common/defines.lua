...
NDiplomacy = {
	...
	FABRICATE_CLAIM_COST = 1,
	FABRICATE_CLAIM_COST_MODIFIER_PER_CLAIM = .1,
	...
	CLAIM_PEACE_COST_DIP_FRACTION = -0.5,			-- Fraction of dipcost you pay for claims
...
NCountry = {
	...
	CLAIM_LOSE = 250,								-- how many years until a claim is lost.
...
NAI = {
	...
	DIPLOMATIC_INTEREST_DISTANCE = 100, -- If border distance is greater than this, diplomatic AI will have less interest in the country
	CONQUEST_INTEREST_DISTANCE = 1000, -- Beyond this range, AI is less interested in conquest of provinces
	...
	POWERFUL_ALLY_PENALTY = 0,	-- Penalty on alliance for them already having a powerful ally if much stronger
	RIVAL_ALLIANCE_PENALTY = 80, -- Penalty on alliance chance for being allied to rivals
	...
	PEACE_TERMS_PROVINCE_NO_CB_MULT = 1, -- AI desire for a province is multiplied by this if it doesn't have a valid cb for it (only used when annexing, not applied to cores)
	PEACE_TERMS_PROVINCE_CORE_MULT = 5.0, -- AI desire for a province is multiplied by this if it has a core on it
	PEACE_TERMS_PROVINCE_WARGOAL_MULT = 4.0, -- AI desire for a province is multiplied by this if it is the wargoal
	...
	PEACE_TERMS_PROVINCE_VASSAL_MULT = 0.3, -- AI desire for a province is multiplied by this if it would go to their vassal instead of themselves
	PEACE_TERMS_PROVINCE_REAL_ADJACENT_MULT = 2, -- AI desire for a province is increased by this multiplier for each owned adjacent province
	PEACE_TERMS_PROVINCE_NOT_ADJACENT_MULT = 2, -- AI desire for a province is multiplied by this if it is not adjacent at all (including vassals and other provinces being taken in peace)
	PEACE_TERMS_PROVINCE_NO_INTEREST_MULT = 1.5, -- AI desire for a province is multiplied by this if it is not on their conquest list
	...
	PEACE_TERMS_PROVINCE_OVEREXTENSION_MAX_MULT = 5, -- AI desire for a province is multiplied by this if it has 0% overextension (not applied to cores)
	...
	PEACE_TERMS_HUMILIATE_VALUE_MAX = 1, -- Max AI desire for humiliating its' enemy
	...
	DIPLOMATIC_ACTION_CLAIM_THRONE_MAX_DISTANCE = 1000, -- AI will not claim throne if border distance is higher than this
	...
	DIPLOMATIC_ACTION_WARNING_MAX_DISTANCE = 500, -- AI will not warn if border distance is higher than this
	...
	DIPLOMATIC_ACTION_FABRICATE_CLAIM_BASE_FACTOR = 300, -- AI scoring for fabricating claims is always increased by this as long as the province is a conquest priority
	DIPLOMATIC_ACTION_FABRICATE_CLAIM_STRATEGY_FACTOR = 500, -- AI scoring for fabricating claims based on strategic conquest priorities
	DIPLOMATIC_ACTION_FABRICATE_CLAIM_OTHER_CB_FACTOR = 100, -- AI scoring for fabricating claims if they already have another CB usable on the province
	DIPLOMATIC_ACTION_FABRICATE_CLAIM_NOT_ADJACENT_FACTOR = 200, -- AI scoring for fabricating claims if the province is not adjacent
	DIPLOMATIC_ACTION_FABRICATE_CLAIM_HRE_FACTOR = 100, -- AI scoring for fabricating claims if both parts are HRE
	DIPLOMATIC_ACTION_FABRICATE_CLAIM_HRE_EMPEROR_FACTOR = 100, -- AI scoring for fabricating claims if province is HRE and they are emperor (does not stack with the above penalty)
